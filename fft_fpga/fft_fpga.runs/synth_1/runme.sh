...
HD_PWD='C:/D_drive_backup/Working/FPGA_AI_25_2/fft_fpga/fft_fpga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_test_fft.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_test_fft.tcl
