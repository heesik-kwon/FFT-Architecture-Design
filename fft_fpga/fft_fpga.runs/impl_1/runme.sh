...
HD_PWD='C:/D_drive_backup/Working/FPGA_AI_25_2/fft_fpga/fft_fpga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_test_fft.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_test_fft.tcl -notrace
